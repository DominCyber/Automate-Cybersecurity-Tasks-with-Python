...
## Objective
Coursera Google Cybersecurity Professional Certificate Course work intend to impart practical cybersecurity skills. This guided project utilizes a virtual enviroment to rapidly familiarize users with Python-enabled automation for cybersecurity tasks. Specifically, this project lets users demonstrate processes that import, open, read, extract, parse, and update data from an external log file, utilizing the various components of the Python Programming Language.
